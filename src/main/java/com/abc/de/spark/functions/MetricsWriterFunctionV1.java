 ...
 *
 */
public class MetricsWriterFunctionV1 implements VoidFunction<JavaRDD<Row>> {

	private static final long serialVersionUID = -8384212971616625152L;
	private static final Logger LOGGER = LoggerFactory.getLogger(MetricsWriterFunctionV1.class);
	 ...
	 */
	public MetricsWriterFunctionV1(Configuration config, SQLContext sqlContext) {
		this.config = config;
	 ...
	 */
	public MetricsWriterFunctionV1() {
		/*
	...
	public void call(JavaRDD<Row> rdd) throws Exception {
		StructType schema = DataTypes
				.createStructType(new StructField[] { DataTypes.createStructField("MID", DataTypes.IntegerType, false),
						...
						DataTypes.createStructField("METRIC", DataTypes.BinaryType, true) });
