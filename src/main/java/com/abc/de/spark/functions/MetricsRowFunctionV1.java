 ...
 *
 */
public class MetricsRowFunctionV1 implements FlatMapFunction<Iterator<String>, Row> {

	private static final long serialVersionUID = -7295965590916588108L;
	private static final Logger LOGGER = LoggerFactory.getLogger(MetricsRowFunctionV1.class);
	 ...
	 */
	public MetricsRowFunctionV1(Map<String, Integer> metricsMeta, Map<String, String> hostToAppMap,
