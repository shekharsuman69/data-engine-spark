 ...
 *
 */
public class MetricsWriterFunction implements VoidFunction<JavaRDD<Row>> {

	private static final long serialVersionUID = -8384212971616625152L;
	private static final Logger LOGGER = LoggerFactory.getLogger(MetricsWriterFunction.class);
	 ...
	 */
	public MetricsWriterFunction(Configuration config, SQLContext sqlContext) {
		this.config = config;
