...
import com.abc.de.spark.functions.MetricsRowDeserializeFunction;
 ...
 *
 */
public class MetricsHandlerV4 extends BaseHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(MetricsHandlerV4.class);
	 ...
	 */
	public MetricsHandlerV4(Configuration config) {
		super(config);
	}
	...
	public static void main(String[] args) {
		...
		MetricsHandlerV4 handler = new MetricsHandlerV4(config);
		handler.execute();
	}
	...
	protected void execute() {
		...
		JavaDStream<Row> windowStream = rowStream.window(Durations.minutes(5), Durations.minutes(1));

		//JavaDStream<Row> flatStream = windowStream.mapPartitions(new MetricsRowDeserializeFunction());

		metricStream.print(1);
		rowStream.print(5);
		windowStream.print(3);
		//flatStream.print(4);
